...
namespace HT4
{
    public partial class ImportDataFromExelToNganh : Form
    {
        DbConnection db;
        public string path;
        public ImportDataFromExelToNganh(string s)
        {
            if (db == null)
            {
                db = new DbConnection();
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    string s = "INSERT INTO [dbo].[Nganh]([ma_Nganh],[ten_Nganh],[y_Nghia]) VALUES('"+item.Text + "',N'"+item.SubItems[1].Text+"',N'"+item.SubItems[2].Text+"')";
